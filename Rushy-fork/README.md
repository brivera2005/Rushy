...
> **Rushy fork:** This tree is maintained as **Rushy = StreamVault + Plex**. See [RUSHY.md](RUSHY.md) for migration notes, Plex integration plan, and license obligations. Legacy Rushy lives in `../frontend/` (unchanged).
